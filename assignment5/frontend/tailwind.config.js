...
const generatePalette = require(path.resolve(__dirname, ('src/themes/tailwind/utils/generate-palette')));
...
const config = {
    ...
    plugins    : [
        ...
        require(path.resolve(__dirname, ('src/themes/tailwind/plugins/theming')))({themes}),
